    ...
    return (
        <SafeAreaView style={styles.root}>
            ...
            <ScrollView style={styles.scrollContainer}>
                ...
                <Text style={styles.text_style}>If you have any questions or concerns about Ultra Search or the OpenAI ChatGPT API, please visit the OpenAI blog at <Text style={styles.link} onPress={() => Linking.openURL('https://openai.com/blog/chatgpt/')}>https://openai.com/blog/chatgpt/</Text> for more information.</Text>
